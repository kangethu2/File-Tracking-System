<?php
            ...
            if(isset($_POST['go']))
            {
              ...
              $result = mysql_query("SELECT * FROM staff WHERE username =   '$username' and password=MD5('$password')") or die(mysql_error());
...
<div class="container-fluid" style="margin-top: 10px">
  <div class="row justify-content-center">
    ...
    <div class="col-md-6 col-offset-3" align="center">
      <img height="150" width="350" src="../logo/logo4.png"><br><br>
